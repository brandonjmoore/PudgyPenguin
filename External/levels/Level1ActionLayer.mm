...
-(void)addFish {
    ...
    if (penguin2 != nil) {
        if (!gameOver) {
            [self createFish2AtLocation:ccp(screenSize.width * 0.85, screenSize.height * 0.18)];
            numFishCreated++;
...
-(id)initWithLevel1UILayer:(Level1UILayer *)level1UILayer {
    if ((self = [super init])) {
        ...
        //penguin's platform
        [self createPlatformAtLocation:ccp(winSize.width * 0.8f,winSize.height * 0.767f) ofType:kSmallPlatform withRotation:1.5];
        
        //penguin
        [self createPenguin2AtLocation:ccp(winSize.width * 0.8198f, winSize.height * 0.85f)];
        
        
        //bottom right platform
        [self createPlatformAtLocation:ccp(winSize.width * 0.9f,winSize.height * 0.08f) ofType:kMediumPlatform withRotation:1.6];
        
        
        //bottom bouncy boxes
        [self createBoxAtLocation:ccp(winSize.width * 0.47, winSize.height * 0.05) ofType:kBouncyBox];
        [self createBoxAtLocation:ccp(winSize.width * 0.21, winSize.height * 0.05) ofType:kBouncyBox];
        
        
        //median boxes
        [self createBoxAtLocation:ccp(winSize.width * 0.86, winSize.height * 0.5) ofType:kBouncyBox];
        [self createBoxAtLocation:ccp(winSize.width * 0.47, winSize.height * 0.5) ofType:kBouncyBox];
        [self createBoxAtLocation:ccp(winSize.width * 0.08, winSize.height * 0.5) ofType:kBouncyBox];
