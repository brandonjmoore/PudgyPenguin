...
@class Level15UILayer;
@class Penguin2;
@class Fish2;

@interface Level15ActionLayer : CCLayer {
    //Characters
    Penguin2 *penguin2;
    Fish2 *fish2;
    Box *box;
...
-(id)initWithLevel15UILayer:(Level15UILayer *)level15UILayer;
