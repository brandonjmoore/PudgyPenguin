...
#define kGKAchievementAnimeTime     .5f
#define kGKAchievementDisplayTime   3.0f

#define kGKAchievementDefaultSizePhone   CGRectMake(0.0f, 0.0f, 284.0f, 52.0f);
#define kGKAchievementFrameStartPhone    CGRectMake(18.0f, -53.0f, 284.0f, 52.0f);
#define kGKAchievementFrameEndPhone      CGRectMake(18.0f, 10.0f, 284.0f, 52.0f);

#define kGKAchievementDefaultSizePad   CGRectMake(220.0f, 30.0f, 284.0f, 52.0f);
#define kGKAchievementFrameStartPad    CGRectMake(18.0f, -83.0f, 284.0f, 52.0f);
#define kGKAchievementFrameEndPad      CGRectMake(18.0f, 10.0f, 284.0f, 52.0f);

#define kGKAchievementText1Phone         CGRectMake(10.0, 6.0f, 264.0f, 22.0f);
#define kGKAchievementText2Phone         CGRectMake(10.0, 20.0f, 264.0f, 22.0f);
#define kGKAchievementText1WLogoPhone    CGRectMake(45.0, 6.0f, 229.0f, 22.0f);
#define kGKAchievementText2WLogoPhone    CGRectMake(45.0, 20.0f, 229.0f, 22.0f);

#define kGKAchievementText1Pad         CGRectMake(230.0, 36.0f, 264.0f, 22.0f);
#define kGKAchievementText2Pad         CGRectMake(230.0, 50.0f, 264.0f, 22.0f);
#define kGKAchievementText1WLogoPad    CGRectMake(265.0, 36.0f, 229.0f, 22.0f);
#define kGKAchievementText2WLogoPad    CGRectMake(265.0, 50.0f, 229.0f, 22.0f);
