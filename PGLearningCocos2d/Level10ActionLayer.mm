...
-(void) createClearButton {
    ...
    [clearButtonMenu setPosition:ccp(winSize.width * 0.94f, winSize.height * 0.96)];
...
-(void)doHighScoreStuff {
    ...
    if (remainingTime > [app getHighScoreForLevel:kLevel10]) {
...
-(id)initWithLevel10UILayer:(Level10UILayer *)level10UILayer {
    if ((self = [super init])) {
        ...
        [FlurryAnalytics logEvent:@"Level 10 Started"];
