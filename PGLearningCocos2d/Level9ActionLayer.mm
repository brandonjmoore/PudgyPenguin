...
-(void) doNextLevel {
    ...
    if (appDel != nil) {
        [appDel saveMaxLevelUnlocked:[NSNumber numberWithInt:10]];
    }
...
-(void)doHighScoreStuff {
    ...
    if (remainingTime > [app getHighScoreForLevel:kLevel9] && [app getHighScoreForLevel:kLevel9] > 0) {
...
-(id)initWithLevel9UILayer:(UILayer *)level9UILayer {
    if ((self = [super init])) {
        ...
        [Flurry logEvent:@"Level 9 Started"];
